...
#define ENABLE_STEPPER_DRIVER_INTERRUPT() STC_REG->timer3_ctl |= TIMER3_RUN
...
void digipot_init() //Initialize Digipot Motor Current
{
    ...
    TCCR5B = (TCCR5B & ~(_BV(CS50) | _BV(CS51) | _BV(CS52))) | _BV(CS50); //xt:timer5? TCCR5B decide freq
  #endif
}
